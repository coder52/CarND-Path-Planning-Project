      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          else
          {
            ...
            //Redefine refrence state as previouspath end points
          ...
          {
            //shift car refrence angle to 0 degree
            ...
            std::cout<<"ptsy[i]:"<<ptsy[i]<<"\n";
          }
          std::cout<<"angle:"<<ref_yaw<<"\n";
          ...
          for(int i=1; i<=50-previous_path_x.size();i++)
          {
            ...
            // rotate back to normal after rotating it aerlier
            ...
            std::cout<<"x_point:"<<x_point<<"\n";
            std::cout<<"y_point:"<<y_point<<"\n";
